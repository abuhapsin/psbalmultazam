...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 02, 2017 at 11:43 AM
...
CREATE TABLE IF NOT EXISTS `biaya_daftar` (
`id_biaya_daftar` bigint(10) NOT NULL,
...
INSERT INTO `biaya_daftar` (`id_biaya_daftar`, `nominal`, `nama_bank`, `no_rekening`, `atas_nama`, `status`) VALUES
(1, 350000, 'Bank Syari''ah Mandiri (BSM) KCP Kuningan', '7047101349', 'PRS AL_MULTAZAM', 'on');
...
CREATE TABLE IF NOT EXISTS `calon_siswa` (
  ...
  `sdr_kandung` int(10) NOT NULL,
  `sdr_tiri` int(10) NOT NULL,
  `sdr_angkat` int(10) NOT NULL,
  `telepon` varchar(20) NOT NULL,
  `ukuran_baju` varchar(4) NOT NULL,
  `riwayat_penyakit` text NOT NULL,
  `arsip_akte` enum('Y','T') NOT NULL,
  `arsip_kk` enum('Y','T') NOT NULL,
  `arsip_ijazah` enum('Y','T') NOT NULL,
  `arsip_skhun` enum('Y','T') NOT NULL,
  `nama_ayah` varchar(30) NOT NULL,
  `tmp_lahir_ayah` varchar(30) NOT NULL,
  `tgl_lahir_ayah` date NOT NULL,
  `agama_ayah` varchar(20) NOT NULL,
  `telp_ayah` varchar(20) NOT NULL,
  `pekerjaan_ayah` bigint(20) NOT NULL,
  ...
  `pekerjaan_ibu` bigint(20) NOT NULL,
  `penghasilan_ibu` double NOT NULL,
  `nis_saudara` varchar(20) NOT NULL,
...
INSERT INTO `calon_siswa` (`no_daftar`, `nama_lengkap`, `nisn`, `jk`, `tempat_lahir`, `tanggal_lahir`, `agama`, `warga_negara`, `email`, `status_anak`, `bahasa`, `gol_darah`, `tinggi`, `berat_badan`, `foto`, `rt`, `rw`, `alamat`, `desa`, `kec`, `kab`, `prov`, `anak_ke`, `sdr_kandung`, `sdr_tiri`, `sdr_angkat`, `telepon`, `ukuran_baju`, `riwayat_penyakit`, `arsip_akte`, `arsip_kk`, `arsip_ijazah`, `arsip_skhun`, `nama_ayah`, `tmp_lahir_ayah`, `tgl_lahir_ayah`, `agama_ayah`, `telp_ayah`, `pekerjaan_ayah`, `penghasilan_ayah`, `nama_ibu`, `tmp_lahir_ibu`, `tgl_lahir_ibu`, `agama_ibu`, `telp_ibu`, `pekerjaan_ibu`, `penghasilan_ibu`, `nis_saudara`, `tgl_update`) VALUES
('PRSB17090001', 'GHINA', '9945934431', 'Perempuan', 'TES ALAMAT', '2017-09-28', 'Islam', 'WNI', 'a@yahoo.com', '', '', '', 0, 0, '', '001', '001', 'TES ALAMAT', '3208091006', '320809', '3208', '32', 0, 0, 0, 0, '08123456788', '', '', 'Y', 'Y', 'Y', 'Y', 'TES AYAH', '', '0000-00-00', '', '', 0, 0, 'TES IBU', '', '0000-00-00', '', '', 0, 0, '', '0000-00-00'),
('PRSB17090002', 'GHINA', '9945934431', 'Perempuan', 'TES ALAMAT', '2017-09-28', 'Islam', 'WNI', 'a@yahoo.com', '', '', '', 0, 0, '', '001', '001', 'TES ALAMAT', '3208091006', '320809', '3208', '32', 0, 0, 0, 0, '08123456788', '', '', 'Y', 'Y', 'Y', 'Y', 'TES AYAH', '', '0000-00-00', '', '', 0, 0, 'TES IBU', '', '0000-00-00', '', '', 0, 0, '', '0000-00-00'),
('PRSB17090003', 'GHINA', '9945934431', 'Perempuan', 'TES ALAMAT', '2017-09-28', 'Islam', 'WNI', 'a@yahoo.com', '', '', '', 0, 0, '', '001', '001', 'TES ALAMAT', '3208091006', '320809', '3208', '32', 0, 0, 0, 0, '08123456788', '', '', 'Y', 'Y', 'Y', 'Y', 'TES AYAH', '', '0000-00-00', '', '', 0, 0, 'TES IBU', '', '0000-00-00', '', '', 0, 0, '', '0000-00-00'),
('PRSB17100004', 'WIYAN WIYANTIKA', '9966497013', 'Perempuan', 'KUNINGAN', '1996-08-26', 'Islam', 'WNI', 'a@yahoo.com', '', '', '', 0, 0, '', '001', '001', 'TES ALAMAT', '', '320801', '3208', '32', 0, 0, 0, 0, '08123456788', '', '', 'Y', 'Y', 'Y', 'Y', 'TES AYAH', '', '0000-00-00', '', '', 0, 0, 'TES IBU', '', '0000-00-00', '', '', 0, 0, '', '0000-00-00'),
('PRSB17100005', 'WIYAN WIYANTIKA', '9966497013', 'Perempuan', 'KUNINGAN', '1996-08-26', 'Islam', 'WNI', 'a@yahoo.com', '', '', '', 0, 0, '', '001', '001', 'TES ALAMAT', '', '320801', '3208', '32', 0, 0, 0, 0, '08123456788', '', '', 'Y', 'Y', 'Y', 'Y', 'TES AYAH', '', '0000-00-00', '', '', 0, 0, 'TES IBU', '', '0000-00-00', '', '', 0, 0, '', '0000-00-00'),
('PRSB17100006', 'WIYAN WIYANTIKA', '9966497013', 'Perempuan', 'KUNINGAN', '1996-08-26', 'Islam', 'WNI', 'a@yahoo.com', '', '', '', 0, 0, '', '001', '001', 'TES ALAMAT', '', '320801', '3208', '32', 0, 0, 0, 0, '08123456788', '', '', 'Y', 'Y', 'Y', 'Y', 'TES AYAH', '', '0000-00-00', '', '', 0, 0, 'TES IBU', '', '0000-00-00', '', '', 0, 0, '', '0000-00-00'),
('PRSB17100007', 'WIYAN WIYANTIKA', '9966497013', 'Perempuan', 'KUNINGAN', '1996-08-26', 'Islam', 'WNI', 'a@yahoo.com', '', '', '', 0, 0, '', '001', '001', 'TES ALAMAT', '', '320801', '3208', '32', 0, 0, 0, 0, '08123456788', '', '', 'Y', 'Y', 'Y', 'Y', 'TES AYAH', '', '0000-00-00', '', '', 0, 0, 'TES IBU', '', '0000-00-00', '', '', 0, 0, '', '0000-00-00'),
('PRSC17100008', 'MUHAMAD ABU HAPSIN', '9948733290', 'Laki-laki', 'KUNINGAN', '1994-08-22', 'Islam', 'WNI', 'a@yahoo.com', '', '', '', 0, 0, '', '012', '004', 'JL. SYEH MUHIBAT', '3208091004', '320809', '3208', '32', 0, 0, 0, 0, '123456', '', '', 'Y', 'Y', 'Y', 'Y', 'TES NAMA AYAH', '', '0000-00-00', '', '', 0, 0, 'TES NAMA IBU', '', '0000-00-00', '', '', 0, 0, '', '0000-00-00');

-- --------------------------------------------------------

--
-- Table structure for table `daftar_psb`
--

CREATE TABLE IF NOT EXISTS `daftar_psb` (
`id_daftar_psb` bigint(20) NOT NULL,
  `tgl_input` date NOT NULL,
  `wkt_input` time NOT NULL,
  ...
  `nama_ayah` varchar(30) NOT NULL,
  `nama_ibu` varchar(30) NOT NULL,
  `jenjang_am` varchar(10) NOT NULL,
  `sumber_info` varchar(15) NOT NULL,
  `biaya_daftar` double NOT NULL,
  `status` enum('Proses','Bayar','Off') NOT NULL
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=6 ;

--
-- Dumping data for table `daftar_psb`
--

INSERT INTO `daftar_psb` (`id_daftar_psb`, `tgl_input`, `wkt_input`, `nisn`, `nama_lengkap`, `jk`, `tempat_lahir`, `tanggal_lahir`, `prov`, `kab`, `kec`, `kel`, `alamat`, `rt`, `rw`, `telp`, `email`, `nama_ayah`, `nama_ibu`, `jenjang_am`, `sumber_info`, `biaya_daftar`, `status`) VALUES
(1, '2017-09-28', '08:47:16', '9945934431', 'GHINA', 'Perempuan', 'TES ALAMAT', '2017-09-28', '32', '3208', '320809', '3208091006', 'TES ALAMAT', '001', '001', '08123456788', 'a@yahoo.com', 'TES AYAH', 'TES IBU', 'smpit', 'Keluarga', 350002, 'Bayar'),
(2, '2017-09-28', '09:31:27', '123456', 'TES NAMA', 'Laki-laki', 'TMP TES', '2017-09-28', '33', '3319', '331902', '3319021005', 'TES ALAMAT', '001', '001', '08123456788', 'a@yahoo.com', 'TES AYAH', 'TES IBU', 'smpit', 'Keluarga', 350003, 'Proses'),
(3, '2017-10-02', '04:11:23', '9948733290', 'MUHAMAD ABU HAPSIN', 'Laki-laki', 'KUNINGAN', '1994-08-22', '32', '3208', '320809', '3208091004', 'JL. SYEH MUHIBAT', '012', '004', '123456', 'a@yahoo.com', 'TES NAMA AYAH', 'TES NAMA IBU', 'smait', 'Keluarga', 350003, 'Bayar'),
(4, '2017-10-02', '06:22:03', '1', 'Q', 'Laki-laki', 'Q', '2017-10-02', '18', '1871', '187106', '1871061005', 'TES ALAMAT', '001', '001', '08123456788', 'a@yahoo.com', 'TES AYAH', 'TES IBU', 'smpit', 'Keluarga', 350004, 'Proses'),
(5, '2017-10-02', '11:01:01', '9966497013', 'WIYAN WIYANTIKA', 'Perempuan', 'KUNINGAN', '1996-08-26', '32', '3208', '320801', '', 'TES ALAMAT', '001', '001', '08123456788', 'a@yahoo.com', 'TES AYAH', 'TES IBU', 'smpit', 'Keluarga', 350005, 'Bayar');
...
INSERT INTO `jenjang_pendidikan` (`id_jenjang`, `nama_jenjang`, `keterangan`) VALUES
(1, 'Yayasan', 'Yayasan'),
(2, 'TK', 'TK'),
(3, 'SD', 'SD'),
(4, 'SMP', 'SMP'),
...
--
-- Table structure for table `kode_pendaftaran`
--

CREATE TABLE IF NOT EXISTS `kode_pendaftaran` (
...
--
-- Dumping data for table `kode_pendaftaran`
--

INSERT INTO `kode_pendaftaran` (`id_kode`, `kode`, `jenjang_am`, `jk`) VALUES
(1, 'PRSB', 'smpit', 'Perempuan'),
(2, 'PRSA', 'smpit', 'Laki-laki'),
(3, 'PRSC', 'smait', 'Laki-laki'),
(4, 'PRSD', 'smait', 'Perempuan');

-- --------------------------------------------------------

--
-- Table structure for table `konf_pembayaran`
--

CREATE TABLE IF NOT EXISTS `konf_pembayaran` (
`id_konf_pemb` bigint(10) NOT NULL,
  `nisn` varchar(15) NOT NULL,
  `tgl_bayar` date NOT NULL,
  `nominal` double NOT NULL,
  `metode_pemb` enum('Cash','Transfer') NOT NULL,
  `keterangan` text NOT NULL,
  `status` enum('Proses','Accept','Reject') NOT NULL
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=4 ;

--
-- Dumping data for table `konf_pembayaran`
--

INSERT INTO `konf_pembayaran` (`id_konf_pemb`, `nisn`, `tgl_bayar`, `nominal`, `metode_pemb`, `keterangan`, `status`) VALUES
(1, '9945934431', '2017-09-29', 100000, 'Cash', 'tesss', 'Accept'),
(2, '9948733290', '2017-10-02', 350003, 'Cash', 'cash', 'Accept'),
(3, '9966497013', '2017-10-02', 350000, 'Cash', 'cash', 'Accept');
...
INSERT INTO `kontrak` (`id_kontrak`, `nama_kontrak`, `keterangan`) VALUES
(1, 'Kontrak', ''),
(2, 'Training', ''),
(3, 'Tetap', ''),
...
--
-- Table structure for table `login_calon_siswa`
--

CREATE TABLE IF NOT EXISTS `login_calon_siswa` (
...
--
-- Dumping data for table `login_calon_siswa`
--

INSERT INTO `login_calon_siswa` (`id_login`, `username`, `password`, `nisn`) VALUES
(2, 'PRSB17090001', 'rqdqjjp', '9945934431'),
(5, 'PRSB17100007', 'jpjwtzs', '9966497013'),
(6, 'PRSC17100008', 'wvyqygh', '9948733290');

-- --------------------------------------------------------

--
-- Table structure for table `prestasi_siswa_pendaftar`
--

CREATE TABLE IF NOT EXISTS `prestasi_siswa_pendaftar` (
`id_prestasi` bigint(20) NOT NULL,
  `no_daftar` varchar(15) NOT NULL,
  `nisn` varchar(20) NOT NULL,
  `jenis_prestasi` enum('Olahraga','Seni','Sains','Keagamaan','Lainnya') NOT NULL,
  `tingkat_prestasi` enum('Sekolah','Kecamatan','Kabupaten','Provinsi','Nasional','Internasional','Lainnya') NOT NULL,
...
INSERT INTO `profesi` (`id_profesi`, `nama_profesi`, `keterangan`) VALUES
...
--
-- Table structure for table `prs_info`
--

CREATE TABLE IF NOT EXISTS `prs_info` (
`id_info_prs` bigint(20) NOT NULL,
...
--
-- Dumping data for table `prs_info`
--

INSERT INTO `prs_info` (`id_info_prs`, `tanggal`, `judul_info`, `isi_info`, `menu_info`, `no_urut`, `status`) VALUES
(1, '2017-09-26', 'MUQODIMAH', '<p><strong>Assalamu&#39;alaikum Warahmatullahi Wabarakatuh,</strong><br />\r\n<br />\r\nSegala puji bagi Allah SWT atas semua kenikmatan dan karunia-Nya. Pondok Pesantren Terpadu Al-Multazam melalui Panitia Rekrutmen Santri (PRS) telah melaksanakan Tes Seleksi masuk Pondok Pesantren Terpadu Al-Multazam untuk jenjang SMPIT dan SMAIT. Berkenaan dengan hal itu, Kami Keluarga Besar Pondok Pesantren Terpadu Al-Multazam menyampaikan:<br />\r\n<br />\r\n1. Terimakasih atas kepercayaan yang diberikan kepada kami untuk menitipkan putra/putrinya di Pondok Pesantren Terpadu Al-Multazam.<br />\r\n2. Selamat kepada peserta tes yang dinyatakan lulus masuk Pondok Pesantren Terpadu Al-Multazam.<br />\r\n3. Terimakasih atas partisipasi peserta tes yang dinyatakan tidak lulus.</p>\r\n', 'beranda', '1', 'on'),
(2, '2017-09-26', 'SURAT KEPUTUSAN', '<p><strong>SURAT KEPUTUSAN</strong><br />\r\nPONDOK PESANTREN TERPADU AL-MULTAZAM<br />\r\nNomor : 117/SKEP/P4.DN-PPT.AM/III/2017<br />\r\n<strong>TENTANG</strong><br />\r\nPENERIMAAN SANTRI BARU TAHUN PELAJARAN 2017/2018<br />\r\nPONDOK PESANTREN TERPADU AL-MULTAZAM<br />\r\n<br />\r\n<strong>MUDIR PONDOK PESANTREN TERPADU AL-MULTAZAM</strong><br />\r\n<br />\r\n<strong>Menimbang:</strong><br />\r\na. Bahwa Seleksi Masuk Pondok Pesantren Terpadu Al-Multazam Tahun Pelajaran 2017/2018 merupakan salah satu program tahunan.<br />\r\nb. Bahwa terbatasnya kemampuan dan daya tampung yang ada sementara animo masyarakat cukup besar untuk mendaftarkan putra-putrinya ke Pondok Pesantren.<br />\r\nc. Rekomendasi Rapat Pimpinan tanggal 9 Desember 2016 tentang adanya seleksi Penerimaan Santri Baru sesuai dengan kriteria penerimaan.<br />\r\n<br />\r\n<strong>Mengingat :</strong><br />\r\na. Program Kerja Pondok Pesantren Terpadu Al-Multazam tentang seleksi calon santri baru.<br />\r\nb. Standar Penerimaan Panitia Rekrutment Santri (PRS) Pondok Pesantren Terpadu Al-Multazam.<br />\r\n<br />\r\n<strong>Memperhatikan :</strong><br />\r\nHasil Sidang Kelulusan Pada tanggal 7 Maret 2017 tentang Calon Santri Baru yang dinyatakan Lulus di Pondok Pesantren Terpadu Al-Multazam Tahun Pelajaran 2017/2018 yang dihadiri oleh Pembina, Pengurus Yayasan, Pengurus Pondok Pesantren dan Panitia Rekrutmen Santri (PRS).<br />\r\n<br />\r\n<strong>M E M U T U S K A N</strong><br />\r\n<br />\r\n<strong>Menetapkan:</strong><br />\r\n<strong>Pertama :</strong>&nbsp;Nama-nama yang tercantum pada lampiran 1 (Satu) Surat Keputusan ini dinyatakan LULUS seleksi dan diterima menjadi santri Pondok Pesantren Terpadu Al-Multazam.<br />\r\n<strong>Kedua :</strong>&nbsp;Nama-nama yang sudah dinyatakan LULUS wajib melunasi keuangan sesuai dengan ketentuan yang waktunya mulai dari tanggal ditetapkannya surat keputusan ini sampai dengan 22 Maret 2017.<br />\r\n<strong>Ketiga :</strong>&nbsp;Apabila sampai tanggal 22 Maret 2017 tidak melunasi keuangan tersebut dalam poin di atas, maka dinyatakan mengundurkan diri.<br />\r\n<strong>Keempat :</strong>&nbsp;Surat Keputusan ini berlaku sejak tanggal ditetapkan dan untuk dilaksanakan.<br />\r\n<strong>Kelima :</strong>&nbsp;Apabila dikemudian hari terdapat kekeliruan dalam keputusan ini, maka akan diadakan peninjauan dan perbaikan sebagaimana mestinya.<br />\r\n<br />\r\nDitetapkan di : Kuningan<br />\r\nPada tanggal&nbsp;&nbsp; : 8 Maret 2017<br />\r\n<strong>Mudir Ma&#39;had,</strong><br />\r\n<br />\r\nttd<br />\r\n<br />\r\n<strong>KH. Adin Nurhaedin, Lc.</strong></p>\r\n', 'beranda', 'i', 'on');
...
--
-- Indexes for table `daftar_psb`
--
ALTER TABLE `daftar_psb`
 ADD PRIMARY KEY (`id_daftar_psb`);
...
--
-- Indexes for table `kode_pendaftaran`
--
ALTER TABLE `kode_pendaftaran`
 ADD PRIMARY KEY (`id_kode`);

--
-- Indexes for table `konf_pembayaran`
--
ALTER TABLE `konf_pembayaran`
 ADD PRIMARY KEY (`id_konf_pemb`);
...
--
-- Indexes for table `login_calon_siswa`
--
ALTER TABLE `login_calon_siswa`
 ADD PRIMARY KEY (`id_login`);

--
-- Indexes for table `prestasi_siswa_pendaftar`
--
ALTER TABLE `prestasi_siswa_pendaftar`
...
--
-- Indexes for table `prs_info`
--
ALTER TABLE `prs_info`
 ADD PRIMARY KEY (`id_info_prs`);
...
--
ALTER TABLE `biaya_daftar`
MODIFY `id_biaya_daftar` bigint(10) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `daftar_psb`
--
ALTER TABLE `daftar_psb`
MODIFY `id_daftar_psb` bigint(20) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=6;
--
...
--
-- AUTO_INCREMENT for table `kode_pendaftaran`
--
ALTER TABLE `kode_pendaftaran`
MODIFY `id_kode` int(10) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `konf_pembayaran`
--
ALTER TABLE `konf_pembayaran`
MODIFY `id_konf_pemb` bigint(10) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `kontrak`
--
ALTER TABLE `kontrak`
MODIFY `id_kontrak` bigint(20) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `login_calon_siswa`
--
ALTER TABLE `login_calon_siswa`
MODIFY `id_login` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT for table `prestasi_siswa_pendaftar`
--
ALTER TABLE `prestasi_siswa_pendaftar`
MODIFY `id_prestasi` bigint(20) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `profesi`
--
ALTER TABLE `profesi`
MODIFY `id_profesi` bigint(20) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=33;
--
-- AUTO_INCREMENT for table `prs_info`
--
ALTER TABLE `prs_info`
MODIFY `id_info_prs` bigint(20) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
