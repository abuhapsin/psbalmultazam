    	...
    	<form action="<?php echo base_url('prs/simpan_update_pendaftar'); ?>" method="post" class="form-horizontal">  
			<div class="col-md-20">
				<div class="nav-tabs-custom">
					...
					<input type="hidden" name='no_daftar' value='<?php echo $dsiswa->no_daftar; ?>'>
					<div class="tab-content">
						<div class="tab-pane" id="siswa">
							<div class="box-body">
								...
								<div class="form-group">
									<label class="col-sm-2"  style="width: 100%;">Warga Negara</label>
									<div class="col-xs-4">
										<select class="form-control select2 " style="width: 100%;" name='warga_negara' >
